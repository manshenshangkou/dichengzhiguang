...
public class UIStretch : MonoBehaviour
{
	public enum Style
	{
		...
		Both,
		BasedOnHeight,
		FillKeepingRatio, // Fits the  so that it entirely fills the specified container keeping its ratio
		FitInternalKeepingRatio // Fits the /item inside of the specified container keeping its ratio
	}
	...
	/// <summary>
	/// The size that the item/ should start out initially.
