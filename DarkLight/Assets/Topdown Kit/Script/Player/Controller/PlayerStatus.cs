...
public class PlayerStatus : MonoBehaviour {
	...
	public SubAttribute statusAdd; //次属性（来源于装备和技能）
	public SumAttribute statusCal; //总属性
	public SumEquip statusEquip;
	public StatusGrowth statusGrowth,growthSetting; //升级后属性成长值
	
	public float hpRegenTime; //每秒回复的生命值
	public float mpRegenTime; //每秒回复的魔法值
	...
	void Start () {
        //初始化了最大经验值、人物的成长、人物的属性、最大HP/MP值、调用了自动回复HP/MP的方法
        expMax = startExp * status.lv *multipleExp;//当前等级的最大经验值
